...
public class extendedActivityTest {
    ...
    public void testExtendedActivity() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(content().string(equalTo("extendedActivity updated")));

        userInfo userInfoNew = userInfoMapper.selectByPrimaryKey(id);
        assert (userInfoNew.getExchangescore() - userInfoOld.getExchangescore()) == 5;
        assert (userInfoNew.getScoretotal() - userInfoOld.getScoretotal()) == 5;
        printUser(id);
    }
}
