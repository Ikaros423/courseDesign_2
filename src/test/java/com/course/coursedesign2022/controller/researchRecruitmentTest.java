...
public class researchRecruitmentTest {
    ...
    public void testResearchRecruitment() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(content().string(equalTo("researchRecruitment updated")));

        userInfo userInfoNew = userInfoMapper.selectByPrimaryKey(id);
        assert (userInfoNew.getExchangescore() - userInfoOld.getExchangescore()) == 8;
        assert (userInfoNew.getScoretotal() - userInfoOld.getScoretotal()) == 8;
        printUser(id);
    }
}
